angular.module('starter.publishInformationControllers', [])//information
    .controller('information', function ($state,$scope, $rootScope, publishInformationServices, system, $ionicPopup) {
        function getInfo() {
        ...
        $rootScope.informationSaveInfo = function () {
            setTimeout(function () {
                system.bindNavTool({
                    rightText: "保存草稿",
                    toolClick: function () {
                        var promise = publishInformationServices.saveInfo($rootScope.informationEphemeralData);
                        if (promise) {
        ...
        $scope.publishEvent = function () {
            ...
            var promise = publishInformationServices.publishInfo($rootScope.informationEphemeralData);
            if (promise) {
                if (promise) {
                    promise.success(function () {
                        $ionicPopup.show({
