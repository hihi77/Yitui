angular.module('starter.publishInvestigateControllers', [])
    .controller('investigate', function ($scope, $rootScope, publishInvestigateServices, $state,$stateParams, system, $ionicPopup) {
        ...
        $rootScope.investigateSaveInfo = function () {
            setTimeout(function () {
                system.bindNavTool({
                    rightText: "保存草稿",
                    toolClick: function () {
                        var promise = publishInvestigateServices.saveInfo($rootScope.investigateEphemeralData,$stateParams.source);
                        if (promise) {
    ...
    .controller('investigateSubject', function ($scope, $rootScope, publishInvestigateServices, $ionicHistory, $stateParams, $state, $ionicPopup, system) {
        ...
        $scope.saveQuestion = function () {
          ...
          if($state.current.name=='chat-publish-investigate'){
            //聊天界面调查发布
          }else {
            var promise = publishInvestigateServices.publishInfo($rootScope.activityEphemeralData);
          }
            if (promise) {
                if (promise) {
                    promise.success(function () {
